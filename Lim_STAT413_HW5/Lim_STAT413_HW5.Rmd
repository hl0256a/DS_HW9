---
title: "STAT 413 Data Science HW 5"
...
pnorm(q = 0.70, mean = -1.124615, sd = 5.977673)
...
# H(0) :  population mean = 0.95
# H(A) :  population mean does not equal 0.95
...
t.test(Stockreturns, mu = 0, var.equal = FALSE)

#The Null hypothesis cannot be rejected because the p-value is > than .05.Furthermore, 0 is not in my confidence interval, which means I can reject the Null hypothesis. 
...
#The mean monthly return of investment was x=-1.124615. This means the broker is performing worse than average. 
