---
title: "STAT 413 Homework 9 Web Scraping Using an API"
...
```{r}
#DS 413/613  Homework 9  Web Scraping using an API
...
census_api_key("9d741b3a47d8eebc4f3bf383a807c165842ea6d8")
install = TRUE

#2) Using ACS census data from 2015, show and use R code to do the following:

#a) Produce a tibble that shows the median income estimates and the margin of errors for white males ages 35 to 44 in the counties of California.  The required variable code starts with the characters BO1OO1. Use the table to find the other characters.
